...
<div class="right-nav">
  <div
    class="link"
    onClick="window.location.href='https://github.com/creaticoding/fedev.kr'">
    <a
      style=" color: rgb(198, 203, 209); text-decoration: none
      !important;display: inline-block;"
      title="Home page"
      href="https://github.com/creaticodinfg">
      <div>
        <svg
          height="24"
          viewBox="0 0 16 16"
    ...
    <div
      style=" display: inline-block; font-size: 1.25rem; vertical-align: top;">
      GitHub
    </div>
  </div>
</div>
