...
<div class="right-nav">
  <div
    class="link"
    onClick="window.location.href='https://github.com/creaticoding'">
    <a
  ...
  <div
    class="link"
    onClick="window.location.href='https://www.youtube.com/channel/UC4aO5bFqP0lqgst-iv3q4sw'">
          ...
          <g>
            <g>
              <path
                ...
                c-1.24,0.82-2.93,1.24-5.06,1.24C95.65,49.29,93.93,48.87,92.69,48.03z
                M99.66,43.71c0.34-0.9,0.52-2.37,0.52-4.4v-8.59
              ...
              <path
                ...
                M188.95,25.53c-0.31,0.39-0.52,1.03-0.63,1.91
              ...
              <path
                ...
                C179.36,29.84,179.17,27.43,178.8,25.69z
                M173.11,36.93c0,2.01-0.08,3.58-0.25,4.72c-0.16,1.14-0.44,1.95-0.83,2.43
